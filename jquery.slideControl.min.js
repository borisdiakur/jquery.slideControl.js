...
b.pageX;var c=Math.max(0,Math.min((b-a.offset().left)/a.width(),1)),e;e=f(a,d);a.trigger("onStart",e);a.trigger("onChanged",e);if(a.data("steps")){e=a.width();var g=e/(a.data("steps")-1);b=Math.round((b-a.offset().left)/g);var k=Math.max(0,Math.min(g*b/e,1));d.stop().animate({left:100*k+"%"},150,function(){k!==a.data("relativePosition")&&a.data("relativePosition",k);a.trigger("onComplete",f(a,d))})}else d.stop().animate({left:100*c+"%"},150,function(){c!==a.data("relativePosition")&&a.data("relativePosition",
c);a.trigger("onComplete",f(a,d))})});g(l).on("mousemove touchmove",function(b){!d.hasClass("dragable")||m()&&0<=String(b.originalEvent).indexOf("MouseEvent")||(b=Math.max(0,Math.min(((b.originalEvent&&b.originalEvent.touches&&b.originalEvent.touches[0].pageX?b.originalEvent.touches[0].pageX:b.pageX)-a.offset().left)/a.width(),1)),d.css("left",100*b+"%"),b!==a.data("relativePosition")&&a.data("relativePosition",b),a.trigger("onChanged",f(a,d)))}).on("mouseup touchend touchcancel",function(b){g("body").css("overflow",
"").off("touchmove",n);d.hasClass("dragable")&&(isNaN(parseInt(a.data("steps"),10))?a.trigger("onComplete",f(a,d)):s(a,d),a.removeClass("dragable"),d.removeClass("dragable"),g("html, body").css("cursor",""))})}var e;e={init:function(b){var c=g.extend({currentRelativePosition:0,steps:void 0,currentStep:0,onStart:function(){},onChanged:function(){},onTargetSnapPositionChanged:function(){},onComplete:function(){}},b);c.currentStep+=1;return this.each(function(){t(this,c)})},slideToStep:function(b){q({step:b,
steps:this.data("steps"),slideControl:this})},slideToRelativePosition:function(b){r({relativePosition:b,slideControl:this})}};g.fn.slideControl=function(b){if(e[b])return e[b].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof b||!b)return e.init.apply(this,arguments)}})(jQuery,window,document);